...
<link rel="stylesheet" href="/joden/login/css/style.css" type="text/css"/>
...
<script type="text/javascript">
	...
	function searchPw(){
		...
		f.action = "<%=cp%>/joden/cabin/membership/searchPw.gos";
		f.submit();
...
<div style="margin: auto;">
    ...
    <div style="height: 30px; display: flex; align-items: center; justify-content: center;">
        ...
        <input type="button" value="취소" class="btn2" onclick="javascript:location.href='<%=cp%>/cabin/login.gos';"/>
    </div>
