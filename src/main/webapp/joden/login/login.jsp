...
<div>
    <div>
        ...
        <input type="button" value=" 회원가입 " class="btn2" onclick="location='<%=cp%>/cabin/membership/created.gos';"/>
    </div>
</div>
...
<div>
    ...
    <div >
        <a href="<%=cp%>/cabin/membership/login/searchId.gos">
            아이디 찾기
        </a>
    </div>
...
<div>
    ...
    <div>
        <a href="<%=cp%>/cabin/membership/login/searchPw.gos">
            비밀번호 찾기
        </a>
    </div>
