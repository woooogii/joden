...
<link rel="stylesheet" type="text/css" href="<%=cp%>/joden/myPage/scc/myCart.css" />
<link rel="stylesheet" type="text/css" href="<%=cp%>/joden/myPage/scc/dcart.css" />
<script type="text/javascript" src="<%=cp%>/joden/myPage/util.js"></script>
						...
						<tbody class="center">
							...
							<c:forEach var="cart" items="${cartList }">
								<tr class="">
									...
									<a href="${articleUrl }&num=${cart.productNum}">
									<img style="max-width: 100px;" src="${imagePath }/${cart.imgSaveFileName }"></a>
									</td>
									<td class="left"><strong class="name" id="basket_prod_id_0">${cart.productName}</strong></td>
									
									<td class="right">${cart.cartAmount }
									<span class=""> 
									...
									<span class="displaynone">${cart.cartAmount }</span></td>
									
									<td>
										<div><strong>${cart.price}</strong><p class="displaynone"></p></div>
									</td>
									...
									<td class="button">
										...
										<a href="javascript:;" onclick="Basket.deleteBasketItem(0);"></a>
										<a href="${deletePath }?name=${cart.productName}" class="btnNormal"> <i class="icoDelete"></i>
											삭제</a></td>
								</tr>
							</c:forEach>
							...
							<c:forEach var="cart" items="${cartList }">
							    <tr>
							        <td colspan="10">
							            ...
							            <strong>${cart.cartAmount * cart.price }<span class="displaynone">()</span></strong>
							            + 배송비 <span>3,000</span>
							            <span class="displaynone"> </span> 
							            = 합계 : <strong class="gIndent10">
							            <span class="txt18">${cart.cartAmount * cart.price+3000}</span>원</strong>
							            <span class="displaynone"> </span>
							        </td>
							    </tr>
						    </c:forEach>
